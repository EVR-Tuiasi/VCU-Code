...
uint16 bankselpins[THERMISTOR_BANKS] = {32,33,38,39,44,45,46,64,65,66,67,68,78,80,81,98},
		bankselpinsid[THERMISTOR_BANKS] = {53,52,15,14,67,66,65,39,38,29,28,95,45,43,42,70},
